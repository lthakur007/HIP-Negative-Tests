...
cout<<"The output of hipMemcpy(NULL,str,100,hipMemcpyHostToDevice) is: "<<out<<endl;

out=hipGetErrorString(hipMemcpy(0,str,100, hipMemcpyHostToDevice));

cout<<"The output of hipMemcpy(0,str,100,hipMemcpyHostToDevice) is: "<<out<<endl;
out=hipGetErrorString(hipMemcpy(ptr,NULL,100, hipMemcpyHostToDevice));

cout<<"The output of hipMemcpy(ptr,NULL,100,hipMemcpyHostToDevice) is: "<<out<<endl;
